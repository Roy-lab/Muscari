...
void print_usage() 
{
	cout <<"\n\nUsage: ./muscari -s specorder -e orthogroup -k maxk -t speciestree -c clusterassignments -r rand -o outputDir -m learn -b baseSpecies -i inittype -p p_diagonal_nonleaf" << endl;
